...
useEffect(() => {
  const fetchTWEETS = async () => {
    try {
      ...
      const res = await fetch(`http://${LOCAL_IP}:3000/fetched-tweets`); // this is the default android emulator address for localhost, for physical devices its the ip address of the computer running the server
